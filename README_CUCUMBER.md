...
Примітки:
- Існуючі `BaseTest` та інші TestNG‑класи можна або зберегти для порівняння, або інкапсулювати їх логіку в Hooks/Page Object.
- Логіку ініціалізації WebDriver з `BaseTest` перенесіть у хуки (`@Before`, `@After`).
...
За потреби винесіть фабрику браузера в окремий утилітарний клас. Якщо вже є готові налаштування у `BaseTest`, пере використайте їх у хуках.
...
3) Перенести ініціалізацію WebDriver із `BaseTest` у Cucumber‑хуки.  
